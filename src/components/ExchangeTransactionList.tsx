...
interface ExchangeTransactionListProps {
  ...
  isLoading: boolean;
  onStatusChange?: (transactionId: string, status: TransactionStatus) => Promise<boolean>;
}
...
const ExchangeTransactionList: React.FC<ExchangeTransactionListProps> = ({
  ...
  const handleStatusChange = async (transactionId: string, status: TransactionStatus) => {
