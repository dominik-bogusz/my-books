...
const BookDetail = () => {
  ...
  const [activeTab, setActiveTab] = useState<'details' | 'reviews' | 'exchange'>('details');
  ...
  return (
    <div className='container py-4'>
      ...
      {activeTab === 'reviews' && book && (
        <BookReviewSystem book={book} />
      )}
              ...
              <div className="col-12">
                ...
                {!isAuthenticated && (
                  <div className="alert alert-info mt-3">
                    ...
                    Zaloguj się, aby wymieniać się książkami z innymi użytkownikami.
                  </div>
                )}
              </div>
            </div>
